...
function bm_find_duplicate_book($title,$author,$publisher) {
    // Busca todos os livros com o título exato, sem limite de 1
    $existing = get_posts(array(
        'post_type'              => 'bm_book',
        'title'                  => $title,
        'posts_per_page'         => -1,  // Pega todos com este título
...
function bm_get_api_keys() {
    ...
    // FASE 35.X: Nome do chatbot (padrão: Bibliotecária Virtual)
...
function bm_render_service_page_content() {
    ...
    document.getElementById('bm-loan-btn').addEventListener('click', function() {
        ...
        xhr.onload = function() {
            ...
            // FASE 36.5: Botão de comprovante após empréstimo
...
// ==========================================
// FASE 36.6: LISTA DE LEITURA OBRIGATÓRIA
// ==========================================
function bm_render_reading_lists_page_content() {
    ...
    // Salvar nova lista ou editar existente
    ...
    // Buscar todas as turmas existentes
